...
TAGM is implemented as part of the pRoloc package for R available from Bioconductor (see \url{https://bioconductor.org/packages/release/bioc/html/pRoloc.html}).
