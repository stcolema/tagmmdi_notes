...
\tnote[a]{Correction to $p$-value is according to the method from \citet{BenjaminiControllingFalseDiscovery1995}.}
}{ \FL
Organism & $p$-value & Adjusted $p$-value\tmark[a] \ML
\emph{Arabidopsis} & 0.572 & 0.859 \NN
\emph{Drosophila} & 0.573 & 0.859 \NN
Mouse & 0.947 & 0.947 \LL
}
...
We use conjugate priors to have the closed form of the distributions to sample from. For the multivariate normal distribution of unknown mean and variance this is a normal-inverse-Wishart (NIW) with 4 associated prior parameters:
\begin{itemize}
