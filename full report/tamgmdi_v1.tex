...
\section{TAGMMDI}
Within each dataset we assume a common prior for each mixture. We overfit a mixture of Dirichlet models on the GO term dataset (i.e. we set the number of cluster to an arbitrarily high number).
...
caption = {Results of cross-validation with a burn-in of 5,000 iterations and a total of 15,000 iterations.},
label = nowidth,
pos = !htb,
label = cv_results
] {lcccc} {
\tnote[a]{Correction to $p$-value is by the Benjamini-Hochberg method.}
}{ \FL
